<?php
 switch ($_REQUEST["acao"]) {
     case 'cadastrar':
         ...
         $sql = "INSERT INTO livro(categoria_id_categoria,titulo_livro,autor_livro, editora_livro,edicao_livro,ano_livro,localidade_livro) 
                 VALUES ('{$categoria}', '{$titulo}','{$autor}','{$editora}','{ $edicao}','{$ano }','{$localidade}')";
     ...
     case 'editar':
        ...
        $sql = "UPDATE livro SET categoria_id_categoria='{$categoria}', titulo_livro='{$titulo}',
        autor_livro='{$autor}',editora_livro='{$editora}',
        edicao_livro='{$edicao}',ano_livro='{$ano}',
