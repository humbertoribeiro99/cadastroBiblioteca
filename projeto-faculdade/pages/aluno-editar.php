...
<form action="?page=aluno-salvar" method="POST">
	...
	<div class="mb-3">
		<label>Nome</label>
		<input type="text" name="nome_aluno" value="<?php print $row->nome_aluno; ?>" 
        class="form-control">
	</div>
	<div class="mb-3">
		<label>Endereço</label>
		<input type="text" name="end_aluno"  value="<?php print $row->end_aluno; ?>" 
        class="form-control">
	</div>
    <div class="mb-3">
		<label>E-mail</label>
		<input type="email" name="email_aluno"  value="<?php print $row->email_aluno; ?>" 
        class="form-control">
	</div>
    <div class="mb-3">
		<label>Fone</label>
		<input type="text" name="fone_aluno"  value="<?php print $row->fone_aluno; ?>" 
        class="form-control">
	</div>
    <div class="mb-3">
		<label>Data de nascimento</label>
		<input type="date" name="data_nasc_aluno"  value="<?php print $row->data_nasc_aluno; ?>" 
        class="form-control">
	</div>
    <div class="mb-3">
		<label>Gênero</label>
