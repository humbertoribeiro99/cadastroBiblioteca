<?php
 switch ($_REQUEST["acao"]) {
     case 'cadastrar':
         ...
         $sql = "INSERT INTO atendente(biblioteca_id_biblioteca, nome_atendente) 
                 VALUES ({$biblioteca}, '{$atendente}')";
     ...
     case 'editar':
        $biblioteca = $_POST["biblioteca_id_biblioteca"];
        $atendente = $_POST["nome_atendente"];
        $sql = "UPDATE atendente SET biblioteca_id_biblioteca={$biblioteca}, nome_atendente='{$atendente}' 
