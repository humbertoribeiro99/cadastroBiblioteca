   ...
   print "</tr>";
    while ($row = $res->fetch_object()) {
        ...
        print "<td>
               ...
               <button class='btn btn-danger' onclick=\"if(confirm('Tem certezaque deseja excluir?')){location.href='?page=biblioteca-salvar&acao=excluir&id_biblioteca=".$row->id_biblioteca."';}else{false;}\">Excluir</button>
        </td>";
        print "</tr>";
